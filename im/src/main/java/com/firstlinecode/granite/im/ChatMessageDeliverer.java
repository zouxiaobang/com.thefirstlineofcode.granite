...
public class ChatMessageDeliverer implements IApplicationConfigurationAware, IChatMessageDeliverer {
	...
	/* (non-Javadoc)
	 * @see com.firstlinecode.granite.leps.im.IChatMessageDeliverer#isMessageDeliverable(com.firstlinecode.granite.framework.processing.IProcessingContext, com.firstlinecode.basalt.protocol.core.stanza.Stanza)
	 */
	@Override
	 ...
	 */
	@Override
	public void deliver(IProcessingContext context, IEventProducer eventService, Message message) {
