package com.firstlinecode.granite.cluster.integration.ignite.config;

import java.io.File;
import java.io.FileInputStream;
import java.util.Properties;

import com.firstlinecode.granite.cluster.integration.ignite.config.Discovery.Strategy;
