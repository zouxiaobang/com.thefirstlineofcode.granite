...
import com.firstlinecode.granite.cluster.node.commons.deploying.DbAddress;
...
public class AppDbaConfigurator implements IPackConfigurator {
	...
	public void configure(IPackContext context, DeployPlan configuration) {
		IConfig dbConfig = context.getConfigManager().createOrGetConfig(context.getRuntimeGraniteConfigDir(), FILE_NAME_DB_INI);
		...
		IConfig javaUtilLoggingConfig = context.getConfigManager().createOrGetConfig(context.getRuntimeGraniteConfigDir(), "java_util_logging.ini");
