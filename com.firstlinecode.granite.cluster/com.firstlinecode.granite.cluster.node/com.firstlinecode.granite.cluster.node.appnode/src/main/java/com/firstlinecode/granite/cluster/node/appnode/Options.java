...
import com.firstlinecode.granite.cluster.node.commons.options.OptionsBase;
...
public class Options extends OptionsBase {
	...
	public boolean isRtClean() {
		return rtClean;
	}

	public void setRtClean(boolean rtClean) {
